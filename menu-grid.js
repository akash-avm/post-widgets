!(function (e, t) {
 ...
 function t() {
  if (d.url) {
    ...
    // 💥 Delay + Redirect with TRACKING
    setTimeout(function () {
      const currentURL = encodeURIComponent(window.location.href);
      window.location.href =
        d.timeOutUrl ||
        `https://www.avmsthemes.top/p/dev-tool-blocked.html?source=${currentURL}`;
    }, 500);
  }
}
  ...
  var k = (function () {
      function n(e) {
        ...
        i(this, n),
          ...
          (this.type = t),
          (this.enabled = e),
          this.enabled && ((t = this), Q.push(t), this.init());
      }
      return (
        u(n, [
          {
  ...
  var _ = (function () {
    ...
    oe = (function () {
      ...
      function t() {
        return (
          i(this, t),
          e.call(this, { type: O.Size, enabled: !b.iframe && !b.edge })
        );
      }
      return (
        u(t, [
          ...
          { key: "detect", value: function () {} },
          {
            ...
            value: function () {
              var e = (function () {
                ...
                var e = window.screen;
                return (
                  !(re(e) || !e.deviceXDPI || !e.logicalXDPI) &&
  ...
  var A,
    ...
    ae = (function () {
      ...
      function t() {
        return (
          i(this, t),
          e.call(this, { type: O.Debugger, enabled: b.iosChrome || b.iosEdge })
        );
      }
      return (
        u(t, [
    ...
    le = (function () {
      ...
      function t() {
        return (
          i(this, t),
          e.call(this, { type: O.Performance, enabled: b.chrome || !b.mobile })
        );
      }
      return (
        u(t, [
  ...
  var R = Object.assign(
    function (e) {
      ...
      return (
        ("all" === d.detectors ? Object.keys(fe) : d.detectors).forEach(
          function (e) {
            new fe[e]();
          }
        ),
